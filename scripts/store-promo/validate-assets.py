...
VIDEO_RULES = (
    ...
    VideoRule(
        "Google / YouTube",
        "Create account and gamertag tutorial",
        ...
        60.0,
        sources=(
            "kit:cross-platform/key-art/modulo-squares-key-art-3840x2160.png",
            "kit:sources/video/tutorials/account-raw.mov",
            "kit:sources/video/tutorials/gamertag-raw.mov",
            "repo:scripts/store-promo/render-youtube-tutorials.sh",
        ),
    ),
    VideoRule(
        "Google / YouTube",
        "Sign-in tutorial",
        "google/video/tutorials/02-sign-in-1920x1080.mp4",
        1920,
        1080,
        3.0,
        60.0,
        sources=(
            "kit:cross-platform/key-art/modulo-squares-key-art-3840x2160.png",
            "kit:sources/video/tutorials/sign-in-raw.mov",
            "repo:scripts/store-promo/render-youtube-tutorials.sh",
        ),
    ),
    VideoRule(
        ...
        "google/video/tutorials/03-navigate-the-app-1920x1080.mp4",
        1920,
        1080,
        3.0,
        60.0,
        sources=(
            "kit:cross-platform/key-art/modulo-squares-key-art-3840x2160.png",
            "kit:sources/video/tutorials/navigation-raw.mov",
            "repo:scripts/store-promo/render-youtube-tutorials.sh",
        ),
    ),
    VideoRule(
        "Google / YouTube",
        "Gameplay tutorial",
        "google/video/tutorials/04-how-to-play-1920x1080.mp4",
        1920,
        1080,
        3.0,
        60.0,
        sources=(
            "kit:cross-platform/key-art/modulo-squares-key-art-3840x2160.png",
            "kit:sources/video/tutorials/gameplay-raw.mov",
            "repo:scripts/store-promo/render-youtube-tutorials.sh",
        ),
    ),
    VideoRule(
...
TEXT_RULES = (
    ...
    TextRule(
        "Google / YouTube",
        "YouTube tutorial metadata",
        "copy/youtube-tutorials.md",
    ),

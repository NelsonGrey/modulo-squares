...
SVC_NAME="actions.runner.mnelson3-modulo-squares.modulo-squares-macos-runner-KRONOS.local"
SVC_NAME=${SVC_NAME// /_}
SVC_DESCRIPTION="GitHub Actions Runner (mnelson3-modulo-squares.modulo-squares-macos-runner-KRONOS.local)"

...
const SOCIAL_LINKS = [
  ...
  {
    label: 'Instagram',
    href: 'https://www.instagram.com/modulosquares/',
    icon: (
      <svg viewBox="0 0 24 24" className="w-4 h-4 fill-current">
  ...
  {
    label: 'Reddit',
    href: 'https://www.reddit.com/r/ModuloSquares/',
    icon: (
      <svg viewBox="0 0 24 24" className="w-4 h-4 fill-current">
  ...
  {
    label: 'TikTok',
    href: 'https://www.tiktok.com/@modulosquares',
    icon: (
      <svg viewBox="0 0 24 24" className="w-4 h-4 fill-current">
  ...
  {
    label: 'YouTube',
    href: 'https://www.youtube.com/@modulosquares',
    icon: (
      <svg viewBox="0 0 24 24" className="w-4 h-4 fill-current">

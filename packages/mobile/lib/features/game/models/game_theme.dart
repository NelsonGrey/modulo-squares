...
const Map<GameThemeId, GameThemePalette> gameThemePalettes = {
  GameThemeId.deepOcean: GameThemePalette(
    ...
    chipCombo: GameChipColors(bg: Color(0xFFE1F5F6), fg: Color(0xFF087985)),
    chipDifficulty: GameChipColors(
      bg: Color(0xFFE3ECF7),
      fg: Color(0xFF245F98),
    ),
    chipFall: GameChipColors(bg: Color(0xFFE7F2FF), fg: Color(0xFF155E9A)),
    chipMove: GameChipColors(bg: Color(0xFFDFF6F2), fg: Color(0xFF096B61)),
    chipRange: GameChipColors(bg: Color(0xFFE6F0F5), fg: Color(0xFF2C607F)),
  ...
  GameThemeId.arcadeNeon: GameThemePalette(
    ...
    chipFall: GameChipColors(bg: Color(0xFF16213B), fg: Color(0xFF5F92FF)),
  ...
  GameThemeId.warmSunset: GameThemePalette(
    ...
    chipCombo: GameChipColors(bg: Color(0xFFFDECC8), fg: Color(0xFF85430F)),
    chipDifficulty: GameChipColors(
      bg: Color(0xFFFCE3D6),
      fg: Color(0xFF913309),
    ),
    chipFall: GameChipColors(bg: Color(0xFFFBEAD9), fg: Color(0xFF95430F)),
    chipMove: GameChipColors(bg: Color(0xFFFFF1E0), fg: Color(0xFF9C4B08)),
    chipRange: GameChipColors(bg: Color(0xFFF7E0CE), fg: Color(0xFF7C3E18)),
    chipDeficit: GameChipColors(bg: Color(0xFFFDE2E2), fg: Color(0xFFB53529)),
  ...
  GameThemeId.candyPop: GameThemePalette(
    ...
    chipCombo: GameChipColors(bg: Color(0xFFFDE1F3), fg: Color(0xFFB80059)),
    chipDifficulty: GameChipColors(
      bg: Color(0xFFF3E1FD),
      fg: Color(0xFF7B1FA2),
    ),
